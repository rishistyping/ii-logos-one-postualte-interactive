...
function corsHeaders(origin) {
  ...
  // Only echo Access-Control-Allow-Origin for known-good callers. For
  // disallowed origins we omit the header — browsers will then reject the
  // response, which is the correct CORS posture.
